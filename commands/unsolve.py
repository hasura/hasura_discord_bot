...
async def command_unsolve(interaction: discord.Interaction.response):
    """
    Marks a thread as unsolved if run in a forum channel thread.
    ...
    :return:
    """
    return await handle_toggle(interaction, "unsolve")
