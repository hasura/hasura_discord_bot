...
async def command_close(interaction: discord.Interaction.response):
    """
    Closes the thread if run in a forum channel thread.
    ...
    :return:
    """
    return await handle_toggle(interaction, "close")
